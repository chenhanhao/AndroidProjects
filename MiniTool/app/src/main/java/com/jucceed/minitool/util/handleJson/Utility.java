package com.jucceed.minitool.util.handleJson;
...
import com.jucceed.minitool.currencyConversion.Country;
import com.jucceed.minitool.currencyConversion.Rate;
import com.jucceed.minitool.inquireIp.Data;
import com.jucceed.minitool.todayInHistory.Article;
...
public class Utility {
   ...
   //             Gson gson = new Gson();
    ...
    public static com.jucceed.minitool.phoneArtribution.Data handleAttrDataResponse(String response){
        if(!TextUtils.isEmpty(response)){
            try{
                JSONObject jsonObject = new JSONObject(response);
                String resultCode = jsonObject.getString("resultcode");
                if(resultCode.equals("200")){
                    JSONObject result = jsonObject.getJSONObject("result");
                    com.jucceed.minitool.phoneArtribution.Data data = new com.jucceed.minitool.phoneArtribution.Data();
                    data.setProvince(result.getString("province"));
                    data.setCity(result.getString("city"));
